...
from  pipeline_two import PipelineTwo
...
joblib.dump(pipeline, f'{MODEL_ROOT_PATH}/pipeline_two.pkl')
joblib.dump(model_, f'{MODEL_ROOT_PATH}/002_model_logistic_regresion.pkl')
shutil.copyfile(f'{SRC_PATH}/pipeline_two.py', f'{MODEL_ROOT_PATH}/pipeline_two.py')
